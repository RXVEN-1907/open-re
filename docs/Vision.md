...
The platform _is_ a plugin system. Core functionality (disassembly, decompilation, graphing) are plugins. Users can replace any component.
...
_This vision is a living document. It will evolve as we learn from users and the ecosystem._
