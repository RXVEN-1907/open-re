...
pub use crate::scanner::{ScanTarget, ScanResult, ScanError, Scanner};

// Re-export types and functions for public API
pub use crate::checks::{Check, get_all_checks, get_check_description};
...
pub use crate::runner::{run_scan_internal, run_scan};
pub use crate::output::{OutputFormat, display_results, print_json_results, print_sarif_results, print_table_results, print_severity_summary};
