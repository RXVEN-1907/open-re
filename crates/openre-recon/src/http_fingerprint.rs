...
use crate::{
    Capability, CapabilityRequest, CapabilityResponse, CommandRegistration, PluginMetadata,
    ReconMetadata, ReconPlugin, ReconPluginConfig, ReconType,
};
use openre_core::error::OpenreResult as Result;
use openre_core::plugin::Plugin;
...
impl Plugin for HttpFingerprintPlugin {
    fn metadata(&self) -> PluginMetadata {
        PluginMetadata {
            name: "http_fingerprint".to_string(),
            version: "0.1.0".to_string(),
            description: "HTTP fingerprinting plugin".to_string(),
            ...
            keywords: vec!["http".to_string(), "fingerprinting".to_string()],
        }
    }
