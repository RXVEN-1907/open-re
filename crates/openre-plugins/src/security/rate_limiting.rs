//! Rate limit enumeration Security Plugin
...
pub fn manifest() -> PluginManifest {
    let metadata = SimplePluginMetadata {
        name: "security-rate_limiting".to_string(),
        version: "0.1.0".to_string(),
        description: "Rate limit enumeration".to_string(),
        ...
        keywords: vec!["security".to_string(), "rate-limiting".to_string()],
    };
...
mod tests {
    ...
    fn test_manifest() {
        let m = manifest();
        assert_eq!(m.name, "security-rate_limiting");
