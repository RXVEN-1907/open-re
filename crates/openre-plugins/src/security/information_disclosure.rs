//! Information Disclosure Security Plugin
...
pub fn manifest() -> PluginManifest {
    PluginManifest {
        metadata: PluginMetadata {
            name: "security-information_disclosure".to_string(),
            version: "0.1.0".to_string(),
            description: "Debug endpoints, stack traces".to_string(),
            ...
            keywords: vec!["security".to_string(), "information-disclosure".to_string()],
        },
...
mod tests {
    ...
    fn test_manifest() {
        let m = manifest();
        assert_eq!(m.metadata.name, "security-information_disclosure");
