//! Rest Api Analysis Security Plugin
...
pub fn manifest() -> PluginManifest {
    PluginManifest {
        metadata: PluginMetadata {
            name: "security-rest_api_analysis".to_string(),
            version: "0.1.0".to_string(),
            description: "OpenAPI/Swagger analysis".to_string(),
            ...
            keywords: vec!["security".to_string(), "rest-api-analysis".to_string()],
        },
...
mod tests {
    ...
    fn test_manifest() {
        let m = manifest();
        assert_eq!(m.metadata.name, "security-rest_api_analysis");
