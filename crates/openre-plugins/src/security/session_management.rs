//! Session Management Security Plugin
...
pub fn manifest() -> PluginManifest {
    PluginManifest {
        metadata: PluginMetadata {
            name: "security-session_management".to_string(),
            version: "0.1.0".to_string(),
            description: "Session fixation, hijacking".to_string(),
            ...
            keywords: vec!["security".to_string(), "session-management".to_string()],
        },
...
mod tests {
    ...
    fn test_manifest() {
        let m = manifest();
        assert_eq!(m.metadata.name, "security-session_management");
