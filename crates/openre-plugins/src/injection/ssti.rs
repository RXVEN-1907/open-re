//! SSTI Plugin
//!
//! Detects Server-Side Template Injection vulnerabilities in common template engines.
...
impl SstiPlugin {
    ...
    fn description(&self) -> &'static str {
        "Detects Server-Side Template Injection vulnerabilities in common template engines (Jinja2, Twig, Freemarker, Velocity, etc.)"
    }
    ...
    fn references(&self) -> Vec<crate::injection::SecurityReference> {
        vec![
            ...
            crate::injection::SecurityReference {
                ...
                id: "CWE-1336".to_string(),
                url: "https://cwe.mitre.org/data/definitions/1336.html".to_string(),
                description: "Improper Neutralization of Special Elements used in a Template Engine".to_string(),
            },
        ]
    }
...
impl Plugin for SstiPlugin {
    ...
    fn new(config: Self::Config) -> Self {
        Self::new(config).expect("Failed to create SSTI plugin")
    }
    ...
    async fn execute(&self, request: CapabilityRequest) -> Result<CapabilityResponse> {
        ...
        info!("Starting SSTI testing for {}", target_url);
...
impl crate::injection::InjectionPlugin for SstiPlugin {
    fn injection_category(&self) -> InjectionCategory {
        InjectionCategory::Ssti
    }
    ...
    fn response_analyzer(&self) -> Box<dyn ResponseAnalyzer> {
        create_response_analyzer(InjectionCategory::Ssti)
    }
}

// Plugin entry point
crate::plugin_entry!(SstiPlugin);