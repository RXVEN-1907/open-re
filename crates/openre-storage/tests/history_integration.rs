...
fn create_test_finding(scan_id: ScanId) -> Finding {
    let mut finding = Finding::new(FindingConfig {
        ...
        description: "Test SQL injection vulnerability".to_string(),
...
async fn test_end_to_end_report_lifecycle() {
    ...
    let summary = ScanSummary {
        ...
        finding_stats: FindingStats {
            ...
            by_cwe: HashMap::new(),
            avg_advanced_risk_score: 85.0,
            max_advanced_risk_score: 85,
...
async fn test_pagination() {
    ...
    for i in 0..10 {
        use openre_core::history::{ScanConfigSummary, ScanProgressSummary, ScanSummary};
        let summary = ScanSummary {
            scan_id: ScanId::new(),
            project_id: None,
            ...
            risk_metrics: openre_core::history::RiskMetricsSummary {
                ...
                risk_level: openre_core::reporting::RiskLevel::Medium,
                critical_count: 0,
                high_count: 0,
                medium_count: 1,
                low_count: 0,
...
fn make_default_finding_stats() -> FindingStats {
    ...
    FindingStats {
        ...
        avg_risk_score: 0.0,
        max_risk_score: 0,
        by_owasp_category: Map::new(),
        by_cwe: Map::new(),
        avg_advanced_risk_score: 0.0,
        max_advanced_risk_score: 0,
        by_remediation_priority: Map::new(),
        exploit_available_count: 0,
        exploited_in_wild_count: 0,
    }
}
